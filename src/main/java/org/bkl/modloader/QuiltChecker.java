...
public class QuiltChecker {
    public QuiltChecker() {
    }

    public static boolean isQuiltInstalled(String mcVersion) {
        ...
        if (versionFolder != null) {
            for (File versionFile : versionFolder) {
                ...
                if (versionFile.getName().contains(mcVersion)) {
                    ...
                    if (f.exists() && checkerJsonForQuilt(f)) {
                        return true;
                    }
                }
            }
    ...
    private static boolean checkerJsonForQuilt(File versionJson) {
            ...
            if (jsonObject.has("libraries")) {
                ...
                for (int i = 0; i < jsonArray.size(); i++) {
                    ...
                    if (jsonObject1.has("name")) {
                        ...
                        if (name.startsWith("org.quiltmc:quilt-loader")) {
                            return true;
                        }
                    }
                }
